...
SELECTOR_ARG = "lr_feature_selector"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run clinical-variable LR experiments.")
    ...
    parser.add_argument("--lr_feature_selector", choices=["none", "lasso", "rfecv"], default=DEFAULT_SELECTOR)
