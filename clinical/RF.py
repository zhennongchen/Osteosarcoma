...
def parse_args():
    parser = argparse.ArgumentParser(description="Run clinical-variable RF experiments.")
    ...
    parser.add_argument("--rf_feature_selector", choices=["none", "lasso", "rfecv"], default=DEFAULT_SELECTOR)
