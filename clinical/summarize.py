#!/usr/bin/env python3
"""Summarize clinical-variable ML experiment outputs into full and compact Excel sheets."""
...
IMAGE_TYPE = "clinical"
DEFAULT_OUTPUT_NAME = "clinical_model_summary.xlsx"
PREFERRED_CLASSIFIER_ORDER = ["SVM", "LR", "RandomForest"]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create Excel summaries for clinical-variable ML experiments.")
