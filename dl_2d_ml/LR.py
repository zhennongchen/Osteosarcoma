...
def parse_args():
    parser = argparse.ArgumentParser(description="Run DL 2D feature LR experiments.")
    ...
    parser.add_argument("--lr_feature_selector", choices=['lasso'], default=DEFAULT_SELECTOR)
