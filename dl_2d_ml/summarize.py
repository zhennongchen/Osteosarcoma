#!/usr/bin/env python3
"""Summarize DL 2D feature ML experiment outputs into full and compact Excel sheets."""
...
DEFAULT_OUTPUT_NAME = "dl_2d_ml_cv_model_summary.xlsx"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create Excel summaries for DL 2D feature ML experiments.")
    parser.add_argument("--task", choices=["Prognosis", "Pathologic"], default=DEFAULT_TASK)
    parser.add_argument("--trial_name", default=DEFAULT_TRIAL_NAME, help="Model/radiomics trial folder name, e.g. dl_2d_ml or dl_2d_ml_cv.")
    parser.add_argument(
        "--models_root",
        type=Path,
        default=None,
