...
def parse_args():
    parser = argparse.ArgumentParser(description="Run DL 2D feature SVM experiments.")
    parser.add_argument("--task", choices=sorted(TASK_TO_LABEL_COL), default=DEFAULT_TASK)
    parser.add_argument("--trial_name", default=DEFAULT_TRIAL_NAME, help="Radiomics/model trial folder name, e.g. dl_2d_ml or dl_2d_ml_cv.")
    ...
    parser.add_argument("--svm_feature_selector", choices=['rfe', 'rfecv', 'lasso'], default=DEFAULT_SELECTOR)
