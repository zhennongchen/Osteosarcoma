...
def parse_args():
    parser = argparse.ArgumentParser(description="Run habitat weighted-average radiomics KNN experiments.")
    ...
    parser.add_argument("--knn_feature_selector", choices=['sfs'], default=DEFAULT_SELECTOR)
