...
def parse_args():
    parser = argparse.ArgumentParser(description="Run habitat weighted-average radiomics SVM experiments.")
    ...
    parser.add_argument("--svm_feature_selector", choices=['rfe', 'sfs', 'rfecv'], default=DEFAULT_SELECTOR)
